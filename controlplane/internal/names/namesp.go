...
func KCPMachineNameGenerator(templateString, clusterName, kthreesControlPlaneName string) NameGenerator {
	return newTemplateGenerator(templateString, clusterName,
		map[string]interface{}{
			"kthreesControlPlane": map[string]interface{}{
				"name": kthreesControlPlaneName,
			},
		})
}
